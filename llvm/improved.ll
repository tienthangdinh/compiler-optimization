; ModuleID = 'improved.cpp'
source_filename = "improved.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_improved.cpp, i8* null }]
...
18:                                               ; preds = %15, %13
  ...
  %21 = add nsw i32 2, %20
  %22 = getelementptr inbounds [10 x i32], [10 x i32]* %5, i64 0, i64 0
...
37:                                               ; preds = %34
  ...
  %43 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %42, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_improved.cpp() #0 section ".text.startup" {
